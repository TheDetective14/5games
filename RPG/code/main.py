...
class Game:
    ...
    def load_images(self):
        self.bullet_surf = pygame.image.load(join('RPG', 'images', 'gun', 'bullet.png')).convert_alpha()

        folders = list(walk(join('RPG', 'images', 'enemies')))[0][1]
        self.enemy_frames = {}
        for folder in folders:
            for folder_path, _, file_names in walk(join('RPG', 'images', 'enemies', folder)):
